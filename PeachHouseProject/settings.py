"""
Django settings for PeachHouseProject project.
...
SECRET_KEY = 'django-insecure-xd!%n5d32$3ca_#x%=se=pk*y)s36j$0x%(x+=56uu)nt$fifl'
...
WSGI_APPLICATION = 'PeachHouseProject.wsgi.application'
